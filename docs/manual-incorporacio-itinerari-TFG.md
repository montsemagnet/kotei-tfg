...
Aquest lloc web forma part d’un treball de fi de grau (TFG) elaborat com a plataforma per publicar itineraris de camp de biologia (geològics, botànics, zoològics, etc.) per tal de preservar i organitzar el coneixement i fer-lo més accessible. El codi s’ha cedit a la universitat i s’ha dissenyat perquè sigui reutilitzable: el professorat pot preparar els seus continguts i, amb el suport del departament de sistemes, incorporar nous itineraris, parades i materials sense haver de construir una web des de zero.
...
https://montsemagnet.github.io/kotei-tfg/itineraris/sau-tavertet/
...
Repositori. El projecte d’origen d’aquest TFG és a https://github.com/montsemagnet/kotei-tfg
...
Nota: l’esquema actual està pensat sobretot per a petrografia; altres observacions poden requerir adaptar camps.
...
Montserrat Magnet Sabata — mariamontserrat.magnet@uvic.cat
