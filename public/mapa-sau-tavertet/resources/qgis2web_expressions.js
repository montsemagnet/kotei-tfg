...
function exp_Xarxaviria_18rule0_eval_expression(context) {
    // tipus = 'mca' AND entorn = 'gen'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('tipus')  == 'mca') && (feature.get('entorn')  == 'gen'));
    } else {
        return ((feature.get('tipus')  == 'mca') && (feature.get('entorn')  == 'gen'));
    }
}
...
function exp_Xarxaviria_18rule1_eval_expression(context) {
    // tipus = 'mvi' AND entorn = 'gen'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('tipus')  == 'mvi') && (feature.get('entorn')  == 'gen'));
    } else {
        return ((feature.get('tipus')  == 'mvi') && (feature.get('entorn')  == 'gen'));
    }
}
...
function exp_Xarxaviria_18rule2_eval_expression(context) {
    // tipus = 'cor' AND entorn = 'gen'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('tipus')  == 'cor') && (feature.get('entorn')  == 'gen'));
    } else {
        return ((feature.get('tipus')  == 'cor') && (feature.get('entorn')  == 'gen'));
    }
}
...
function exp_Xarxaviria_18rule3_eval_expression(context) {
    // tipus  IN ('aut', 'vcd', 'vcu', 'vpd', 'vpu', 'vnc', 'vca') AND entorn = 'gen'

    var feature = context.feature;
    
    if (feature.properties) {
        return ("'aut', 'vcd', 'vcu', 'vpd', 'vpu', 'vnc', 'vca'".indexOf(feature.get('tipus') ) > -1  && (feature.get('entorn')  == 'gen'));
    } else {
        return ("'aut', 'vcd', 'vcu', 'vpd', 'vpu', 'vnc', 'vca'".indexOf(feature.get('tipus') ) > -1  && (feature.get('entorn')  == 'gen'));
    }
}
...
function exp_Xarxaviria_18rule4_eval_expression(context) {
    // entorn  IN ('vfx', 'pvx', 'cnx')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'vfx', 'pvx', 'cnx'".indexOf(feature.get('entorn') ) > -1 ;
    } else {
        return "'vfx', 'pvx', 'cnx'".indexOf(feature.get('entorn') ) > -1 ;
    }
}