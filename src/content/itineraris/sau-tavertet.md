...
dadesModals:
  ...
  socle:
    ...
    introMedia:
      ...
      tipus: animacio
    sections:
      - title: "Context geològic general"
        paragraphs:
          - "La zona de Tavertet i la vall de Sau forma part de la conca terciària de l'Ebre, que es va anar omplint de sediments mentre es produïa l'orogènesi alpina, amb l'aixecament dels Pirineus al nord i de la Serralada Prelitoral al sud."
          - "Aquests sediments terciaris, principalment de l'Eocè, se situen a sobre de materials molt més antics (paleozoics) a través d'una discordança erosiva molt clara a la zona."
      - title: "El sòcol: roques paleozoiques"
        paragraphs:
          - "Al tram baix de l'itinerari (zona del pantà / presa de Sau) s'exposen roques de sòcol com granits i altres materials paleozoics molt més antics que la resta dels estrats sedimentaris que es veuen quan puges cap als cingles."
          - "Aquesta base granítica actua com a «sòcol» sobre el qual després s'hi han acumulat successives sèries sedimentàries continentals i marines del Terciari."
      - title: "Seqüència de materials sobre el sòcol"
        paragraphs:
          - "A mesura que es puja des de Sau cap a Tavertet, l'itinerari travessa una successió vertical molt pedagògica de granit (sòcol), gresos, conglomerats i calcàries."
          - "Els conglomerats i gresos rojos de la base dels cingles (Unitat Vermella) alternen amb fàbriques clast-suportades i matriu-suportades, indicant variacions en el règim d'energia i el contingut de fang del medi deposicional."
      - title: "Formació dels cingles actuals"
        paragraphs:
          - "L'alternança de roques dures (conglomerats i calcàries) amb nivells més tous margosos i gresosos ha afavorit una erosió diferencial molt marcada."
          - "Aquesta erosió ha donat lloc a un relleu en forma de gran «taula» coronada pels cingles verticals de Tavertet i del Far, que s'alcen centenars de metres per damunt del nivell del pantà de Sau."
      - title: "Resum geomorfològic aplicat a l'itinerari"
        paragraphs:
          - "En termes pràctics per a l'itinerari geològic Sau–Tavertet, passes de caminar sobre el sòcol paleozoic a la base (granit, al peu del pantà), a travessar la sèrie de materials sedimentaris terciaris mentre vas guanyant cota fins arribar a la «taula» superior dels cingles."
          - "El paisatge espectacular de parets verticals, replans estructurals i formes en cornisa és la conseqüència directa d'aquesta estructura simple (sòcol + sèrie sedimentària en discordança) i de l'erosió diferencial sobre materials de duresa distinta."
    images:
      - url: "/src/images/itineraris/sau-tavertet/I1-geo1.png"
        alt: "Secció geològica de l'embassament de Sau i els cingles de Tavertet"
      - url: "/src/images/itineraris/sau-tavertet/I1-geo2.png"
        alt: "Secció litològica del sector Sau–Tavertet"
      - url: "/src/images/itineraris/sau-tavertet/I1-periodes1.png"
        alt: "Correlació estratigràfica Eocè–Oligocè"
      - url: "/src/images/itineraris/sau-tavertet/I1-periodes2.png"
        alt: "Cronologia dels esdeveniments geològics al Pirineu oriental"
      - url: "/src/images/itineraris/sau-tavertet/I1-periodes3.png"
