  ...
  - paragraphs:
    ...
    table:
      rows:
        - parada: "P1"
          slug: "I1-P1"
          material: "Monzogranit i pòrfirs (sòcol hercinià)"
          edat: "Paleozoic (310–280 Ma)"
        - parada: "P2"
          slug: "I1-P2"
          material: "Cantera de sauló (regòlit granític)"
          edat: "Quaternari (alteració superficial del sòcol)"
        - parada: "P3"
          slug: "I1-P3"
          material: "Argiles vermelles, Fm. Mediona"
          edat: "Paleocè (66–56 Ma)"
        - parada: "P4"
          slug: "I1-P4"
          material: "Dipòsits de vessant"
...
dadesModals:
  ...
  marc-geologic-regional:
    ...
    sections:
      ...
      - title: "La Conca de l'Ebre i el seu marge oriental"
        paragraphs:
          - "Geològicament, els materials que veiem al trajecte formen part del marge sud-est de la Conca Terciària de l'Ebre, la gran conca d'avantpaís que es va generar com a resposta isostàtica a l'aixecament dels Pirineus durant el Paleogen. A mesura que la serralada pirinenca creixia, el seu pes va provocar la flexió de l'escorça ibèrica cap al sud, creant una depressió allargada on s'anaven acumulant espessos paquets de sediments. La conca de l'Ebre pot acumular fins a 8 km d'espessor de sediments terciaris, provinents de l'erosió de les cadenes circumdants —Pirineus, Serralada Ibèrica i Serralada Costanera Catalana."
          - "A mitjan Eocè, fa uns 47 Ma, la Conca de l'Ebre era una extensa badia que s'obria cap a l'Atlàntic pel Golf de Biscaia, mentre que el marge oriental —on ens trobem— estava flanquejat pels relleus de la Cadena Costera Catalana. Els sediments marins i continentals que es van dipositar en aquest marge oriental són exactament els que recorrem en aquest itinerari: les argiles i gresos vermells de la base, seguits per les cèlebres calcàries nummulítiques que formen la cornisa dels cingles. Cap a finals de l'Eocè, fa uns 37 Ma, la conca va quedar desconnectada del mar obert i va passar a un règim endorreic continental."
  ...
  estratigrafia-litologia:
    intro: "Al llarg de l'itinerari, des de la presa del pantà de Sau fins al poble de Tavertet, travessem una columna estratigràfica completa: des del sòcol cristal·lí paleozoic fins als sediments vermells continentals i les roques grises marines de l'Eocè, responsables dels cingles actuals. Les parades P1–P9 segueixen aquest ordre, de més antiga a més moderna."
    sections:
      - title: "De la base cristal·lina al farciment terciari (P1–P2)"
        subsections:
          - title: "P1 – Presa de Sau: el sòcol paleozoic"
            paragraphs:
              - "A la presa de Sau veiem el sòcol cristal·lí sobre el qual es recolzen tots els materials sedimentaris del Collsacabra. Es tracta de roques metamòrfiques i granitoides paleozoics, similars a les que afloren al massís de les Guilleries: pissarres, filades i granits intensament fracturats, que constitueixen el «continent» antic sobre el qual, molt més tard, es va formar la Conca de l'Ebre."
          - title: "P2 – Cantera de Sau: granit alterat i intrusions"
            paragraphs:
              - "A la cantera de Sau apareix el granit alterat, amb nivells de desintegració i blocs arrodonits, juntament amb petites intrusions filonianes (aplites i dics més màfics) que tallaven el sòcol. Aquesta parada permet veure de prop la textura de la roca mare sobre la qual s'assenten els sediments terciaris."
      - title: "La capa vermella continental (P3–P6)"
        ...
        subsections:
          - title: "P3 – Argiles vermelles paleòcenes"
            paragraphs:
              - "A la P3 es pot observar el nivell d'argiles vermelles: materials fins, plàstics quan s'humitegen, amb tonalitats rogenques degudes als òxids de ferro. Representen antics llacs i depressions on es decantava el material més fi dels sistemes fluvials."
          - title: "P4 – Gresos i conglomerats vermells"
            paragraphs:
              - "A la P4 apareixen gresos i petits conglomerats vermells: arenes cimentades amb còdols dispersos, que corresponen a antics canals de riu i ventalls al·luvials. La textura més gruixuda indica episodis d'energia alta, capaços de transportar fragments més grans."
          - title: "P5 – Contacte dins la capa vermella"
            paragraphs:
              - "La P5 mostra gresos vermells amb un contacte intern entre nivells més massius i altres més laminats. Aquestes variacions reflecteixen canvis en la dinàmica fluvial (episodis d'avingudes, migració de canals) dins d'un mateix ambient continental."
          - title: "P6 – Transició cap als gresos grisos"
            paragraphs:
              - "A la P6 es veu un pas del vermell al gris: els gresos grisos, amb presència d'un nivell oxidat groguenc, marquen la transició entre els ambients estrictament continentals i els primers ambients marginalment marins o de plana costanera. És un punt clau per entendre com la conca es va anar omplint fins connectar amb el mar."
      ...
      - title: "La capa grisa marina (P7–P9)"
        ...
        subsections:
          - title: "P7 – Calcàries nummulítiques («pedra de Girona»)"
            paragraphs:
              - "La P7 és la parada emblemàtica de les calcàries grises amb nummulits, uns foraminífers de mida centimètrica que s'identifiquen fàcilment al camp. Són roques dures, molt resistents a l'erosió, que formen la cornisa superior dels cingles de Tavertet. Representen fons marins poc profunds i ben il·luminats, rics en vida."
          - title: "P8 – Margues del Coll de Malla"
            paragraphs:
              - "A la P8 afloren les margues grisoses del Coll de Malla, roques toves, plàstiques, amb abundants fòssils marins (restes de mol·luscs, etc.). Aquestes margues testimonien un ambient marí més tranquil i fangós; la seva menor duresa les fa especialment vulnerables a l'erosió i expliquen part de l'escalonament dels cingles."
          - title: "P9 – Gresos del Castell"
            paragraphs:
              - "La P9 mostra els gresos del turó del Castell, que alternen amb les margues i formen relleus intermedis. Són arenes marines o de platja, retransportades i cimentades, que completen la seqüència grisa superior abans de passar a altres unitats més modernes del Collsacabra."
      - title: "Columna estratigràfica simplificada i parades"
        table:
          ...
          headers:
            ...
            - "Origen / ambient"
          rows:
            - cells: ["P1", "Sòcol metamòrfic–granític", "Pissarres, granit", "Continent paleozoic antic"]
            - cells: ["P2", "Sòcol intruït", "Granit alterat, dics", "Intrusions magmàtiques al sòcol"]
            - cells: ["P3", "Capa vermella", "Argiles vermelles", "Plans d'inundació fluvials"]
            - cells: ["P4", "Capa vermella", "Gresos i conglomerats", "Canals de riu i ventalls al·luvials"]
            - cells: ["P5", "Capa vermella", "Gresos vermells amb contacte", "Variacions internes en canals fluvials"]
            - cells: ["P6", "Transició", "Gresos grisos", "Ambients marginals, plana costanera"]
            - cells: ["P7", "Capa grisa", "Calcàries amb nummulits", "Mar eocè poc profund"]
            - cells: ["P8", "Capa grisa", "Margues del Coll de Malla", "Fons marí fangós, tranquil"]
            - cells: ["P9", "Capa grisa", "Gresos del Castell", "Arenes marines / de platja"]
    ...
    sections:
      ...
      - title: "Les falles principals del trajecte"
        subsections:
          ...
          - title: "Falla d'Amer"
            paragraphs:
              - "La Falla d'Amer és una de les estructures principals de la Serralada Transversal. És una falla normal profunda que separa el Collsacabra–Guilleries de la fossa de la Selva. En el context del trajecte, actua com a gran «front» tectònic que explica per què el bloc de Tavertet queda elevat respecte a la plana de la Selva i les conques neògenes associades."
          - title: "Falla de Sant Joan de Fàbregues"
            paragraphs:
              - "La Falla de Sant Joan de Fàbregues és una fractura vertical molt notable que ha provocat l'enfonsament d'una part del terreny respecte a l'altra. Un exemple clàssic és que la base del Pla Boixer i l'ermita de Sant Joan de Fàbregues corresponen a la mateixa capa de roca, però l'ermita es troba a un nivell molt més baix per l'efecte del desplaçament tectònic. Aquesta falla connecta estructuralment amb el sistema de Tavertet i contribueix a l'esglaonament de la cinglera."
        mediaItems:
